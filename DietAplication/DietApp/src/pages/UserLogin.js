  ...
  const handleSignIn = async () => {
    if (email.length === 0 || password.length === 0) {
      alert ( 'Email or Password Cannot be Empty!' ), () => false;
        ...
        await axios.post('http://10.0.2.2:5000/api/users/login', {
          email: email,
          password: password,
        })
        .then(async response => {
    ...
    return (
      ...
      <View View style={styles.cantainer}>
        ...
        <View View style={{marginTop:70,backgroundColor:"white"}}>
          ...
          <TextInput style={styles.nameInput} placeholder="Password"   
            ...
            <AntIcon style={styles.icon2} 
            name="key" color="green" size={20} />
          ...
          <View style={styles.endView}>
            <TouchableOpacity
              style={styles.btn2}
              onPress={() => navigation.navigate('U_ForgotPass')}>
